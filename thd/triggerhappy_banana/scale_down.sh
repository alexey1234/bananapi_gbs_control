...
NEW_VALUE=$(( ( (($(sudo i2cget -y 2 0x17 0x18) & 0x7f) << 4) + ($(sudo i2cget -y 2 0x17 0x17) >> 4) +1) )) 
sudo i2cset -r -y -m 0x7f 2 0x17 0x18 $((NEW_VALUE >> 4))
sudo i2cset -r -y -m 0xf0 2 0x17 0x17 $(( (NEW_VALUE & 0x00F) << 4))
